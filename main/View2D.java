...
public class View2D extends JPanel implements Runnable{
    ...
    public View2D(int height, int length){
        ...
        switch (BattlepassMenu.battlepassConfig) {
            case "Battlepass1":
                ballImage = new ImageIcon("main/resources/images/award1-ball.png").getImage();
                backgroundImage = new ImageIcon("main/resources/images/award1-bg.png").getImage();
                break;
            case "Battlepass2":
    ...
    public void applyPowerup(int option){
        switch(option){
            ...
            case 2:
                ...
                objects.balls[objects.ballCount()-1].setPosition(platform.getX() + platform.getSizeX() - objects.balls[objects.ballCount()-1].getRadius()/2, (int)(Config.SCREEN_HEIGHT * 0.75)- platform.getSizeY());
